...
using FN.Store.UI.ViewModels.Produtos.Maps;
...
namespace FN.Store.UI.Controllers
{
	...
	public class ProdutoController : Controller
	{
		...
		public ProdutoController(IProdutoRepository produtoRepository, ITipoDeProdutoRepository tipoDeProdutoRepository)
		{
